...
def resnet50(pretrained=False, loadpath=None, progress=True, **kwargs):
    ...
    """
    return _resnet(
        "resnet50", Bottleneck, [3, 4, 6, 3], pretrained, loadpath, progress, **kwargs
    )
...
def resnet101(pretrained=False, loadpath=None, progress=True, **kwargs):
    ...
    """
    return _resnet(
        "resnet101", Bottleneck, [3, 4, 23, 3], pretrained, loadpath, progress, **kwargs
    )
...
def resnet152(pretrained=False, loadpath=None, progress=True, **kwargs):
    ...
    """
    return _resnet(
        "resnet152", Bottleneck, [3, 8, 36, 3], pretrained, loadpath, progress, **kwargs
    )
