...
class LoadAnnotations(object):
    def __init__(
        self, with_bbox=True, with_label=True, with_mask=False, poly2mask=True
    ):
...
class Resize(object):
    ...
    def _resize_masks(self, results):
        for key in results.get("mask_fields", []):
            ...
            if self.keep_ratio:
                masks = [
                    imrescale(mask, results["scale_factor"], interpolation="nearest")
