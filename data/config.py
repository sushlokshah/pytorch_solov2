...
coco2017_dataset = dataset_base.copy(
    {
        "name": "COCO 2017",
        "data_root": "/home/awi-docker/video_summarization/instance_seg/dataset/coco",
        "train_info": "annotations/instances_train2017.json",
        "trainimg_prefix": "train2017/",
        # "train_images": "/home/awi-docker/video_summarization/instance_seg/dataset/coco",
        # "valid_prefix": "/home/awi-docker/video_summarization/instance_seg/dataset/coco",
        "val_info": "annotations/instances_val2017.json",
        "valimg_prefix": "val2017/",
        # "valid_images": "/home/awi-docker/video_summarization/instance_seg/dataset/coco",
...
resnet18_backbone = backbone_base.copy(
    {
        "name": "resnet18",
        "path": "/home/awi-docker/video_summarization/pytorch_solov2/pretrained/resnet18_nofc.pth",
        "type": "ResNetBackbone",
        "num_stages": 4,
        "frozen_stages": 1,
        "out_indices": (0, 1, 2, 3),
...
resnet34_backbone = backbone_base.copy(
    {
        "name": "resnet34",
        "path": "/home/awi-docker/video_summarization/pytorch_solov2/pretrained/resnet34_nofc.pth",
        "type": "ResNetBackbone",
        "num_stages": 4,
        "frozen_stages": 1,
        "out_indices": (0, 1, 2, 3),
